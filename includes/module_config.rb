...
class ModuleConfiguration
  ...
  # Create a new module config data structure.
  # This structure is meant to hold config for modules.
  ...
  # @return [Object] The stored config variable.
  ...
  # Return all config keys for the specified module.
  # If the module doesn't exist, return nil.
  # @param [String] modName The name of the module for which we are doing this lookup
  # @return [Array] An array containing the config keys.
  ...
  # Return all config values for the specified module.
  # If the module doesn't exist, return nil.
  # @param [String] modName The name of the module for which we are doing this lookup
  ...
  # Return a Hash table containing the config for the specified module.
  # If the module doesn't exist, return nil.
  # @param [String] modName The name of the module for which we are doing this lookup
  # @return [Hash] An array containing the config values.
